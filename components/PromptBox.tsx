...
const PromptBox = ({ isLoading, setIsLoading }) => {
  ...
  const {user,chats,setChats,selectedChat,setSelectedChats} = useAppContext()
  ...
  const sendPrompt = async (e)=>{
    ...
    try {
      e.preventDefault()
      if(!user) return toast.error('Login to send message. Click the Profile icon on bottom left of the sidebar to Login');
      ...
      setSelectedChats((prev)=>({...prev,messages:[...prev.messages,userPrompt]}))
